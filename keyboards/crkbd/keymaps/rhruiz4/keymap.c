...
//,--------------------------------------------------.   ,--------------------------------------------------.
    _______,  SWSD(________R_NUM_1________) , _______,     _______,  SWSD(________L_NUM_2________) , _______,
//|--------+--------------------------------+--------|   |--------+--------------------------------+--------|
    _______,  SWSD(________R_NUM_2________) , _______,     _______,  SWSD(________L_NUM_3________) , TG_NUM ,
//|--------+--------------------------------+--------'   `--------+--------------------------------+--------|
