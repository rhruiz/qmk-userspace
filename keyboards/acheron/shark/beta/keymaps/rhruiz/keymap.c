...
/*  |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------| */ \
      MO_RSE , KC_ESC , KC_TAB , KC_LGUI, MO_LWR , CT_SPC , ST_ENT , MO_RSE , KC_RALT, KC_RGUI, KC_DEL , MO_LWR    \
/*  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------' */ \
  )
...
//|--------+--------------------------------------------+--------------------------------------------+--------|
    KC_LALT,           ____FUNCTIONS_LEFT____           ,           _______R_QWER_R4_______          , KC_RSFT,
//|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
...
//,--------+--------------------------------------------+--------------------------------------------+--------.
    _______, _______,  KC_NO ,  MS_UP ,  KC_NO , MS_WHLD, KC_SLSH,  KC_7  ,  KC_8  ,  KC_9  , KC_MINS, _______,
//|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    _______, _______, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLU, KC_ASTR,  KC_4  ,  KC_5  ,  KC_6  , KC_PLUS, TG_NUM ,
//|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    _______, _______, KC_LPRN, KC_RPRN, KC_UNDS, _______, KC_COMM,  KC_1  ,  KC_2  ,  KC_3  , KC_DOT , _______,
//|--------+--------------------------------------------+--------------------------------------------+--------|
    _______, _______, _______, MS_BTN2, _______, MS_BTN1, _______,LT_RSE_0, _______, _______, _______, _______
//`--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
  ),
...
const rgblight_segment_t PROGMEM fn1_colors[] = RGBLIGHT_LAYER_SEGMENTS({2, 8, LWR_HSV});
const rgblight_segment_t PROGMEM fn2_colors[] = RGBLIGHT_LAYER_SEGMENTS({2, 8, RSE_HSV});
const rgblight_segment_t PROGMEM aug_colors[] = RGBLIGHT_LAYER_SEGMENTS({2, 8, AUG_HSV});
const rgblight_segment_t PROGMEM cfg_colors[] = RGBLIGHT_LAYER_SEGMENTS({2, 8, CFG_HSV});
const rgblight_segment_t PROGMEM num_colors[] = RGBLIGHT_LAYER_SEGMENTS({14, 8, NUM_HSV});
const rgblight_segment_t PROGMEM fun_colors[] = RGBLIGHT_LAYER_SEGMENTS({2, 8, FUN_HSV});
const rgblight_segment_t PROGMEM caps_colors[] = RGBLIGHT_LAYER_SEGMENTS({14, 8, CAPS_HSV});

const rgblight_segment_t PROGMEM qwerty_colors[] = RGBLIGHT_LAYER_SEGMENTS({0, 24, QWERTY_HSV});
const rgblight_segment_t PROGMEM colemak_dh_colors[] = RGBLIGHT_LAYER_SEGMENTS({0, 24, COLEMAK_HSV});
const rgblight_segment_t PROGMEM mac_colors[] = RGBLIGHT_LAYER_SEGMENTS({0, 24, MAC_HSV});
const rgblight_segment_t PROGMEM win_colors[] = RGBLIGHT_LAYER_SEGMENTS({0, 24, WIN_HSV});
