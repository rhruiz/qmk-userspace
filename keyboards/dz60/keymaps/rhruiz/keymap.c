...
#include "rhruiz.h"
#define _DELLWR LT(_LWR, KC_DEL)
#define _DELRSE LT(_RSE, KC_DEL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LWR] = LAYOUT_wrapper(
		...
		_______,  _______,  _______,  _______,  _______,  _DELRSE,  _______,  _______,  _______,  _______,  _______
  ),
  ...
  [_RSE] = LAYOUT_wrapper(
		...
		_______,  _______, _______, _______, _______, _DELLWR,  _______, _______, _______, _______, _______
  ),
