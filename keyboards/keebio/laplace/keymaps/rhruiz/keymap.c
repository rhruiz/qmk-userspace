...
//`----------+--------+--------+--------+--------+---------+--------+--------+---------'
  ...
  [_NUM] = LAYOUT_wrapper(
//,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.
    _______, MS_BTN2,  KC_NO ,  MS_UP ,  KC_NO , KC_WH_D, KC_ASTR,  KC_7  ,  KC_8  ,  KC_9  , KC_MINS, _______, _______,
//|--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------+
    _______  , MS_BTN1, MS_LEFT, MS_DOWN, MS_RGHT, KC_WH_U, KC_SLSH,  KC_4  ,  KC_5  ,  KC_6  , KC_PLUS,     _______   ,
//|----------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------+
