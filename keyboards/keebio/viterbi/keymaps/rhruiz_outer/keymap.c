...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //|-------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+
    _______,  KC_NO ,  MS_UP ,  KC_NO , _______, _______, _______,    _______, _______, _______,  KC_4  ,  KC_5  ,  KC_6  , KC_PLUS,
 //|-------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+
    MS_WHLD, MS_LEFT, MS_DOWN, MS_RGHT, _______, _______, _______,    _______, _______, KC_ASTR,  KC_1  ,  KC_2  ,  KC_3  , KC_MINS,
 //|-------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+
    MS_WHLU, _______, _______, _______, _______, _______, _______,    _______, KC_ENT , KC_EQL ,  KC_0  , _______,  KC_UP , _______,
 //|-------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+
