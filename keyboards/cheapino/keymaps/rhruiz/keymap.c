...
#define LAYOUT_non_base_wrapper(...) LAYOUT_non_base(__VA_ARGS__)
...
/*  ,-----------------------------.     ,-----------------------------.*/ \
        L01  , L02, L03, L04, L05 , ENC,    R01  , R02, R03, R04, R05 , \
/*  |--------+----+----+----+-----|     |--------+----+----+-----+----|*/ \
...
//,--------------------------.        ,--------------------------.
     _______L_QWER_R2_______ , KC_MPLY,  _______R_QWER_R2_______ ,
//|--------------------------|        |--------------------------|
     _______L_QWER_R3_______ ,           _______R_QWER_R3_______ ,
//|--------------------------|        |--------------------------|
     _______L_QWER_R4_______ ,           _______R_QWER_R4_______ ,
...
//,--------------------------.        ,--------------------------.
     ________L_NUM_2________ , TG_NUM ,   ________R_NUM_1________ ,
//|--------------------------|        |--------------------------|
...
//,--------------------------------.        ,--------------------------------.
     REV5(________R_NUM_1________) , TG_NUML,  REV5(________L_NUM_2________) ,
//|--------------------------------|        |--------------------------------|
